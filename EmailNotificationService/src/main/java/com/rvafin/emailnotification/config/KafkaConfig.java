package com.rvafin.emailnotification.config;
...
public class KafkaConfig {
    ...
    ConsumerFactory<String, Object> consumerFactory(){
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);//объод ситуации, когда отправлено сообщение с неверным форматом
